...
public class ResponseTimesGatewayFilter implements GatewayFilter, Ordered {

    private static final Log log = LogFactory.getLog(ResponseTimesGatewayFilter.class);
